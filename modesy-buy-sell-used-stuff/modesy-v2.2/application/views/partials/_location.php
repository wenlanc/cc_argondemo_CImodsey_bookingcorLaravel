...
<?php if (!empty($countries)): ?>
    <div class="row">
        <div class="col-12 col-sm-4 m-b-15">
            <select id="select_countries" name="country_id" class="select2 form-control" onchange="get_states(this.value, '<?php echo $map; ?>');" <?= !empty($is_location_optional) ? '' : 'required'; ?>>
        ...
        <div id="get_states_container" class="col-12 col-sm-4 m-b-15 <?php echo (!empty($country_id)) ? '' : 'display-none'; ?>">
