                    ...
                    <table class="table table-bordered table-striped" role="grid">
                        ...
                        <?php foreach ($invoices as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url(); ?>invoice/<?php echo $item->order_number; ?>?type=admin" class="btn btn-sm btn-success" target="_blank"><i class="fa fa-file-text"></i>&nbsp;&nbsp;<?php echo trans("view_invoice"); ?></a>
                                </td>
                            </tr>
