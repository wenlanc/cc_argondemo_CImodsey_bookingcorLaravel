            ...
            <div class="box-header with-border">
                ...
                <div class="right">
                    <?php if ($order->status != 2): ?>
                        <a href="<?php echo lang_base_url(); ?>invoice/<?php echo $order->order_number; ?>?type=admin" target="_blank" class="btn btn-sm btn-info btn-sale-options btn-view-invoice"><i class="fa fa-file-text-o"></i>&nbsp;&nbsp;&nbsp;<?php echo trans('view_invoice'); ?></a>
                    <?php endif; ?>
                </div>
            </div><!-- /.box-header -->
                    ...
                    <div class="table-order-status">
                        <div class="form-group">
                            ...
                            <select name="order_status" class="form-control">
                                ...
                                <?php endif; ?>
                                <option value="refund_approved" <?php echo ($item->order_status == 'refund_approved') ? 'selected' : ''; ?>><?php echo trans("refund_approved"); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
