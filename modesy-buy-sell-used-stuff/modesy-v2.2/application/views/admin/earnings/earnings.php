				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped" role="grid">
						...
						<tr role="row">
                            ...
                            <th><?php echo trans("discount_coupon"); ?></th>
						...
						<?php foreach ($earnings as $item): ?>
							<tr>
                                ...
                                <td><?php echo price_formatted($item->sale_amount, $item->currency); ?></td>
                                <td><?php echo price_formatted($item->vat_amount, $item->currency); ?>&nbsp;<?= !empty($item->vat_rate) ? '(' . $item->vat_rate . '%)' : ''; ?></td>
                                <td><?php echo price_formatted($item->commission, $item->currency); ?>&nbsp;<?= !empty($item->commission_rate) ? '(' . $item->commission_rate . '%)' : ''; ?></td>
                                <td>
                                    <?php if (!empty($item->coupon_discount)): ?>
                                        <span class="text-danger">-
                                            <?php echo price_formatted($item->coupon_discount, $item->currency);
