...
<div class="row">
    ...
    <div class="col-lg-4 col-md-12">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body" style="min-height: 270px;">
                <div class="form-group">
                    <label class="control-label"><?php echo trans('product_image_upload_limit'); ?></label>
                    <input type="number" name="product_image_limit" class="form-control" value="<?php echo $this->general_settings->product_image_limit; ?>" min="1" required>
                </div>
