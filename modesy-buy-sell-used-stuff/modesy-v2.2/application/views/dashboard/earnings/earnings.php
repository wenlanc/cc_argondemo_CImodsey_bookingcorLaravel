                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped" role="grid">
                        ...
                        <tr role="row">
                            ...
                            <th scope="col"><?php echo trans("vat"); ?></th>
                        ...
                        <?php if (!empty($earnings)): ?>
                            <?php foreach ($earnings as $earning):
                                ...
                                <tr>
                                    ...
                                    <td><?php echo price_formatted($earning->sale_amount, $earning->currency); ?></td>
                                    <td><?php echo price_formatted($earning->vat_amount, $earning->currency); ?>&nbsp;<?= !empty($earning->vat_rate) ? '(' . $earning->vat_rate . '%)' : ''; ?></td>
                                    <td><?php echo price_formatted($earning->commission, $earning->currency); ?>&nbsp;<?= !empty($earning->commission_rate) ? '(' . $earning->commission_rate . '%)' : ''; ?></td>
                                    <td>
                                        <?php if (!empty($earning->coupon_discount)): ?>
                                            <span class="text-danger">-
                                            <?php echo price_formatted($earning->coupon_discount, $earning->currency);
