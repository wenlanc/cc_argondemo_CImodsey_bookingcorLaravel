...
<script>
    ...
    var image_upload_count = <?= $uploaded_image_count; ?>;
    $(function () {
        $('#drag-and-drop-zone').dmUploader({
            ...
            onNewFile: function (id, file) {
                if (image_upload_count >= image_limit) {
                    swal({
                        text: "<?= trans("error_image_limit");?>",
                        icon: "warning",
            ...
            onUploadSuccess: function (id, data) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (obj.result == 1) {
                            document.getElementById("uploaderFile" + id).innerHTML = obj.image_html;
                        }
                    }
                });
            ...
            onFileSizeError: function (file) {
                swal({
                    text: "<?php echo trans('file_too_large') . ' ' . formatSizeUnits($this->general_settings->max_file_size_image); ?>",
                    icon: "warning",
                    button: sweetalert_ok
                });
            },
