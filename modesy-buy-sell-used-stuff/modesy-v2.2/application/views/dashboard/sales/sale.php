            ...
            <div class="col-sm-12">
                <div class="line-detail">
                    ...
                    <?php else:
                        ...
                        <?php endif; ?>
                        <a href="<?php echo lang_base_url(); ?>invoice/<?php echo $order->order_number; ?>?type=seller" target="_blank" class="btn btn-sm btn-info btn-sale-options btn-view-invoice"><i class="fa fa-file-text-o"></i>&nbsp;&nbsp;<?php echo trans('view_invoice'); ?></a>
                    <?php endif; ?>
                </div>
                <?php if ($order->status != 2): ?>
                    <div class="line-detail">
