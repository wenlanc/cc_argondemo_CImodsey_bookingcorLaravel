                ...
                <div id="content" class="card">
                    <div class="card-body invoice p-0">
                        ...
                        <div class="row" style="padding: 45px 30px;">
                            <div class="col-6">
                                <div class="logo">
                                    <img src="<?= get_logo($this->general_settings); ?>" alt="logo">
                                </div>
                                <div>
                            ...
                            <div class="col-6">
                                <div class="float-right">
                                    <p class="font-weight-bold mb-1"><span style="display: inline-block;width: 100px;"><?= trans("invoice"); ?>:</span>#<?= $order->order_number; ?></p>
                                    <p class="font-weight-bold"><span style="display: inline-block;width: 100px;"><?= trans("date"); ?>:</span><?= helper_date_format($order->created_at); ?></p>
                                </div>
                            </div>
                        </div>
