                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <?php if ($order->status != 2):
                                        if ($order->payment_status == 'payment_received'): ?>
                                            <a href="<?php echo lang_base_url(); ?>invoice/<?php echo $order->order_number; ?>?type=buyer" target="_blank" class="btn btn-md btn-info color-white float-right m-b-5 m-r-5"><i class="icon-text-o"></i>&nbsp;<?php echo trans('view_invoice'); ?></a>
                                        <?php else: ?>
